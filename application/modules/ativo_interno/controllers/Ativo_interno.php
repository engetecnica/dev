...
class Ativo_interno  extends MY_Controller {
        ...
        if ($this->input->method() === 'post')  {
            return $this->paginate_json([
                "templates" => [
                    ...
                    [
                        "name" => "patrimonio_html",
                        "view" => "index/patrimonio"   
                    ],
                    [                       
                        "name" => "actions",
                        "view" => "index/actions"
    ...
    protected function paginate_after(object &$row)
    {
        ...
        $row->data_descarte = ($row->data_descarte==null) ? '-' : date('d/m/Y H:i:s', strtotime($row->data_descarte));
    ...
    function adicionar($data = []){
        ...
        $data['codigo_patrominio_increment'] = "ENG".$this->ativo_externo_model->get_codigo_patrimonio_increment();
