                            ...
                            <form action="<?php echo base_url('ativo_interno/salvar'); ?>" method="post" enctype="multipart/form-data">
                                ...
                                <div class="row form-group">
                                    <div class="col col-md-2">
                                        <label for="codigo_patrimonio" class=" form-control-label">Patrimônio</label>
                                    </div>
                                    <div class="col-12 col-md-2">
                                        <?php
                                            if(isset($ativo) && isset($ativo->id_ativo_interno))
                                            {
                                                $codigo_patrimonio = ($ativo->codigo_patrimonio=="") ? 'ENG1' : $ativo->codigo_patrimonio;
                                            } else {
                                                $codigo_patrimonio = $codigo_patrominio_increment;
                                            }
                                        ?>
                                        <input type="text" name="codigo_patrimonio" value="<?php echo $codigo_patrimonio; ?>" class="form-control" readonly>
                                    </div>
                                </div>
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col-12 col-md-4">
                                        <input <?php echo (isset($ativo) && isset($ativo->situacao)) && ($ativo->situacao > 1) ? 'readonly' : '';  ?> required="required" type="text" id="marca" name="marca" placeholder="Marca do Ativo" class="form-control" value="<?php if (isset($ativo) && isset($ativo->marca)) {
                                                                                                                                                                                                                                                                            echo $ativo->marca;
                                                                                                                                                                                                                                                                        } ?>">
                                    </div>
                                </div>
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col-12 col-md-4">
                                        ...
                                        value="<?php if (isset($ativo) && isset($ativo->quantidade)) {
                                                    echo $ativo->quantidade;
                                                } else {
                                                    echo "1";
                                                } ?>">
                                    </div> -->
