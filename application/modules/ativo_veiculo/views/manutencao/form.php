                        ...
                        <div class="card-body">
                            ...
                            <form action="<?php echo $form_url; ?>" method="post" enctype="multipart/form-data">
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col-12 col-md-3">
                                        <input type="number" id="veiculo_horimetro_atual" name="veiculo_horimetro_atual" placeholder="0" class="form-control" min="<?php echo (int) $veiculo->veiculo_horimetro_atual; ?>" value="<?php echo isset($veiculo->veiculo_horimetro_atual) ? (int) $veiculo->veiculo_horimetro_atual : (int) isset($manutencao->veiculo_horimetro_atual) ?? 0; ?>">
                                    </div>
                                </div>
